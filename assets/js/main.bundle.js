...
var _disqus = __webpack_require__(4);
 ...
 */
var fileNameJson = __webpack_require__(6);

__webpack_require__(7); //获取最新评论
  ...
  (0, _jquery.default)(window).scroll(function () {
    ...
    if (iTop > 300) {
      if (document.body.clientWidth > 1200) {
        (0, _jquery.default)('.article-nav-list').fadeIn("slow");
      } else {
        (0, _jquery.default)('.article-nav-list').fadeOut("slow");
      } //返回顶部按钮显示


      (0, _jquery.default)('#back-top').fadeIn("slow");
    } else {
      (0, _jquery.default)('.article-nav-list').fadeOut("slow");
      (0, _jquery.default)('#back-top').fadeOut("slow");
      ;
    }
  });
...
function backTop() {
  (0, _jquery.default)('#back-top').on('click', function () {
...
function addBtn() {
  var doms = (0, _jquery.default)('div.highlight');
  var btn = "<div class=\"copy-save\"><span class=\"copy-code\"><span class=\"iconfont wali-icon-fuzhi\"></span>\u590D\u5236\u4EE3\u7801</span><span class=\"save-code\"><span class=\"iconfont wali-icon-baocun\"></span>\u4FDD\u5B58\u6587\u4EF6</span></div>";

  for (var i = 0; i < doms.length; i++) {
    (0, _jquery.default)('div.highlight').eq(i).append(btn);
  }

  (0, _jquery.default)(document).on('click', '.copy-code', function (e) {
    copyCode(e);
  });
  (0, _jquery.default)(document).on('click', '.save-code', function (e) {
    saveCode(e);
  });
} //复制代码
...
function copyCode(e) {
  var dom = (0, _jquery.default)(e.target).parent().prev().find('code')[0];
  var txt = dom.innerText;
  var flag = (0, _index.default)(txt, {
    debug: true,
...
function saveCode(e) {
  var dom = (0, _jquery.default)(e.target).parent().prev().find('code')[0];
  var cla = (0, _jquery.default)(e.target).parents('.highlighter-rouge').attr('class');
  var str = /language-([a-z]+)/.exec(cla)[1];
  var houzui = fileNameJson[str] ? fileNameJson[str] : 'txt';
  var fileName = "save.".concat(houzui);
  var txt = dom.innerText;
...
var _commethod = __webpack_require__(1);
...
(0, _jquery.default)(function () {
  //获取最新评论
  (0, _commethod.getLastComment)(); //导航

  (0, _commethod.navFade)(); //返回顶部

  (0, _commethod.backTop)(); //获取最新评论	
});
