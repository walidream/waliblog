...
![ssl]({{ site.url }}/assets/image/server/server_1.png)
...
![ssl]({{ site.url }}/assets/image/server/server_32.png)

# 3.xshell工具ssh登录

### 生成ssh

![ssl]({{ site.url }}/assets/image/server/server_2.png)
...
![ssl]({{ site.url }}/assets/image/server/server_3.png)


> 粘贴刚才从xshell复制的秘钥。在末尾添加 [空格][用户名] 这里就是“ google”，保存即可。


![ssl]({{ site.url }}/assets/image/server/server_4.png)


### 用xshell连接

![ssl]({{ site.url }}/assets/image/server/server_5.png)
