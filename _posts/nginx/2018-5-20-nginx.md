...
![ssl]({{ site.url }}/assets/image/nginx/nginx_2.jpg)
...
![ssl]({{ site.url }}/assets/image/nginx/nginx_3.jpg)
...
![ssl]({{ site.url }}/assets/image/nginx/nginx_4.jpg)

如果配置域名也可以直接输入域名进行查看。

![ssl]({{ site.url }}/assets/image/nginx/nginx_5.jpg)
