...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_15.jpg?1234)

当出现nginx代理服务时，客户端所有的请求由nginx接收在转发给服务端，服务单响应给nginx在有nginx响应给客户端。

![ssl](http://walidream.com:9999/blogImage/nginx/nginx_16.jpg?1234)
...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_17.png?1234)
...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_18.png?1234)
...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_19.jpg)

### 常见的nginx作为反向代理支持协议

![ssl](http://walidream.com:9999/blogImage/nginx/nginx_21.jpg)

### 反向代理模式与nginx代理模块

![ssl](http://walidream.com:9999/blogImage/nginx/nginx_20.jpg)

### 常见的nginx作为正向代理支持协议

![ssl](http://walidream.com:9999/blogImage/nginx/nginx_22.jpg)
...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_23.png)
...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_24.png)
...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_25.jpg)
