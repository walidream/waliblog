...
post_nav: ["1.代理分类","2.正向代理","3.反向代理","4.nginx支持的代理协议","5.配置模块","6.反向代理配置","7.正向代理配置"]
---

nginx代理服务，所谓的代理简单理解就是代为办理。生活中常见的代理（代理理财、代理收货等等）。在没有nginx作为代理服务时，客户端直接发送请求，服务端直接响应请求

![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_15.jpg?1234)

当出现nginx代理服务时，客户端所有的请求由nginx接收在转发给服务端，服务单响应给nginx在有nginx响应给客户端。

![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_16.jpg?1234)
...
![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_17.png?1234)
...
![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_18.png?1234)
...
![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_19.jpg)

### 常见的nginx作为反向代理支持协议

![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_21.jpg)

### 反向代理模式与nginx代理模块

![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_20.jpg)

### 常见的nginx作为正向代理支持协议

![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_22.jpg)
...
![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_23.png)
...
![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_24.png)
...
![ssl](http://pif1uj55s.bkt.clouddn.com/nginx/nginx_25.jpg)
