...
![ssl]({{ site.url }}/assets/image/nginx/nginx_46.jpg)

#### GSLB

GSLB是对物理集群的负载均衡。GSLB是依赖于用户和实际部署环境的互联网资源分发技术，不同的目的对应着一系列不同的技术实现。

![ssl]({{ site.url }}/assets/image/nginx/nginx_47.jpg)

#### SLB

![ssl]({{ site.url }}/assets/image/nginx/nginx_48.jpg)
...
![ssl]({{ site.url }}/assets/image/nginx/nginx_49.jpg)
