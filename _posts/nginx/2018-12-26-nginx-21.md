...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_46.jpg)

#### GSLB

GSLB是对物理集群的负载均衡。GSLB是依赖于用户和实际部署环境的互联网资源分发技术，不同的目的对应着一系列不同的技术实现。

![ssl](http://walidream.com:9999/blogImage/nginx/nginx_47.jpg)

#### SLB

![ssl](http://walidream.com:9999/blogImage/nginx/nginx_48.jpg)
...
![ssl](http://walidream.com:9999/blogImage/nginx/nginx_49.jpg)
