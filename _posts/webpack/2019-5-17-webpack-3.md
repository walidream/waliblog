...
![ssl](http://walidream.com:9999/blogImage/webpack/webpack_3.png)

看到命令框输出的信息中包含`./src/index.js`和`./src/assets/css/index.css`就说明css样式被打包到了main.js文件中。接下来手动打开`dist/index.html`文件

![ssl](http://walidream.com:9999/blogImage/webpack/webpack_4.png)
...
yarn run dev
```
![ssl](http://walidream.com:9999/blogImage/webpack/webpack_6.png)
...
![ssl](http://walidream.com:9999/blogImage/webpack/webpack_7.png)
