...
srcPath.nodeModule = path.resolve(srcPath.rootDir, './node_modules');  //包路径
srcPath.src = path.resolve(srcPath.rootDir,'./src');   //源文件
srcPath.dist = path.resolve(srcPath.rootDir,'./dist'); //生成线上

srcPath.assets = 'assets';               //静态资源
srcPath.css = 'assets/css';              //css
srcPath.sass = 'assets/sass'             //sass
srcPath.less = 'assets/less';            //less
srcPath.images = 'assets/images';        //images
srcPath.iconfont = 'assets/iconfont';    //iconfont
