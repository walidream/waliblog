...
post_nav: ["1.术语","2.with语法格式","3.自定义上下文管理器","4.with执行顺序","5.with的as语句","6.exit","7.with使用场景","8.contextlib简化上下文管理器"]
...
上面讲定义一个上下文管理器需要`__enter__`和`__exit__`方法。其实python中给我们提供一个`contextlib`库，将一个函数包装成上下文管理器。
