...
![ssl](http://pi6ah6koe.bkt.clouddn.com/vue/vue_01.jpg)

![ssl](http://pi6ah6koe.bkt.clouddn.com/vue/vue_02.jpg)

设置好了，在`file -> settings -> Editor -> file Types` 找到 `Vue.js Template`模板 选中后在下面添加`+` `*.vue`文件

![ssl](http://pi6ah6koe.bkt.clouddn.com/vue/vue_03.jpg)
...
![ssl](http://pi6ah6koe.bkt.clouddn.com/vue/vue_04.jpg)
...
![ssl](http://pi6ah6koe.bkt.clouddn.com/vue/vue_05.jpg)

解决方案是找到`index.vue`当前的图标，在`file -> settings -> Editor -> file Types`，然后在下面找到`index.vue`删除这个文件类型，保存就可以了。

![ssl](http://pi6ah6koe.bkt.clouddn.com/vue/vue_06.jpg)
![ssl](http://pi6ah6koe.bkt.clouddn.com/vue/vue_07.jpg)
